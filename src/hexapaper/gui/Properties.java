...
public class Properties extends JScrollPane {
	...
	// private Character man=new Character(this,"Pole",new Location(5,4, 0),
	// true,null);
	private Postava man;
	...
	public Properties() {
		...
		/**
		 * PNadpis = new JLabel(); PNadpis.setPreferredSize(new
		 * Dimension(getWidth(), 14)); PNadpis.setFont(new
		 * Font("Times New Roman", Font.BOLD, 13));
		 * PNadpis.setHorizontalAlignment(SwingConstants.CENTER);
		 * PNadpis.setSize(panel.getWidth(), 50); panel_2.add(PNadpis);
		 * panel.add(panel_2);
		 */
